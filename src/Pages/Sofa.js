...
const selectedIds = [2 , 4 , 5 , 8 , 9 , 11 , 12]
const selectedProducts = ProductAllData.filter(product => selectedIds.includes(product.id))

function Sofa({setProductCount}){
    // Animation Products
    useEffect(()=>{
